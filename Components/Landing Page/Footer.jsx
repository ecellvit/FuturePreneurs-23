    ...
    <footer className="relative h-fit flex flex-col sm:flex-row sm:px-14 items-center py-10 gap-5 sm:gap-0">
        ...
        <div className="w-full sm:w-1/3 h-full flex flex-col gap-5 sm:gap-10">
            ...
            <div className="flex flex-col items-center text-sm gap-2">
                <div className="flex items-center"><Image src={phone} className="h-4"/><Link href={"tel:+91 6306311799"}>+91 6306311799</Link></div>
                <div className="flex items-center"><Image src={mail} className="h-3"/><Link href={"mailto:helloecellvit@gmail.com"}>helloecellvit@gmail.com</Link></div>
            </div>
        </div>
        ...
        <div className="w-full sm:w-[10%] h-full flex sm:flex-col gap-3 items-center justify-center">
            <Link target="blank" href={"https://www.facebook.com/ecellvit"}><Image className="h-10" src={fb}/></Link>
            <Link target="blank" href={"https://www.instagram.com/ecell_vit"}><Image className="h-10" src={insta}/></Link>
            <Link target="blank" href={"https://www.linkedin.com/company/ecellvitvellore"}><Image className="h-10" src={linkedin}/></Link>
            <Link target="blank" href={"https://twitter.com/ecell_vit"}><Image className="h-10" src={x}/></Link>
        </div>
    </footer>
  )
}
