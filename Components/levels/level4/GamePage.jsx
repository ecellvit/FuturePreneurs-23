      ...
      <form onSubmit={handleSubmit}>
        <div className="grid min-h-screen gap-3 grid-cols-5 px-10 pt-10">
          ...
          <div className="h-full w-full bg-gradient-to-r from-[#416B93] to-[#0F4474] font-semibold row-span-4 flex flex-col ">
            <h1 className="font-semibold text-xl uppercase">Key Features</h1>
            <textarea
              className="w-full h-full bg-transparent text-white p-2 resize-none"
              name="keyFeatures"
          ...
          <div className="h-full w-full bg-gradient-to-r from-[#416B93] to-[#0F4474] font-semibold row-span-4 flex flex-col ">
            <h1 className="font-semibold text-xl uppercase">Objective</h1>
            <textarea
              className="w-full h-full bg-transparent text-white p-2 resize-none"
              name="objective"
          ...
          <div className="h-full w-full bg-gradient-to-r from-[#416B93] to-[#0F4474] font-semibold row-span-2 flex flex-col">
            <h1 className="font-semibold text-xl uppercase">target audience</h1>
            <textarea
              className="w-full h-full bg-transparent text-white p-2 resize-none"
              name="targetAudience"
          ...
          <div className="h-full w-full bg-gradient-to-r from-[#416B93] to-[#0F4474] font-semibold row-span-2 flex flex-col ">
            <h1 className="font-semibold text-xl uppercase">testing plan</h1>
            <textarea
              className="w-full h-full bg-transparent text-white p-2 resize-none"
              name="testingPlan"
